...
INSERT INTO `patient_visit` VALUES ('khosta',2,'Saw client today \nSpoke about changes\nAgreed to changes\n\nSarah Hamdna RD',1),('khosta',1,'dslkjhflsaflajsd',2),('Mrs. Smith ',1,'Initial Visit with client. \nProblem summary: Eats fast, weight going up. Does not go to the gym, feels that she does not have enough \ntime. ~Does not eat much at work, and so makes up for it once home with big portions and sometimes \ncandies. Concerned about food, eats healthy. \n\nPlan/intervention by RD: Craving change program, organized meal patterns. Healthy eating according to \nCanada´s Food Guide. \n\nAnthropometrics: Height 157 cm, Weight 124 lbs - 56.3 kg (as per RD scale). BMI 22 kg/m2.  Usual weight 50-51.5 kg\nHighest weight: 56.3 kg. Lowest weight 48 kg. Goal weight 50-51.5 kg\n\nClient not exercising at the moment, had an exercise regiment last summer. \n\nClient eats out sometimes: maximum once per week, usually goes out to eat Shawarma with family.\nClient is a mother of 4? kids. Lives with husband and children in single home. \n\nCalculations by RD: \nEnergy (Kcal) 1680-1960 kcal/day for weight maintenance, predicted 1300-1400 kcal for weight loss\n(will go with 1400-1500 kcal to prevent nutrient deficiencies)\nProtein 44.8-61.6 g/day\nFluids ~1680 mL/day\n\nPlease refer to food recall for current details \n\nAssessment: Main issues related to client,s busy schedule. Unable to eat breakfast because it is not planned. Eats fast, adds desserts\nto intake without noticing how much. Often on the goe due to work and her toddler son. Plans on exercising in the future\nMeals generally healthy, but disorganized. no planned meal patterns except supper. \n\nDiagnosis: undesirable food choices related to perception othat lack of resources (time/interpesonal)prevent selection\nof food choices consistent with recommendations as evidenced by intake inconsistent with current Canada Food Guide\nrecommendations. \n\nIntervention: Recommended client have breakfast prepared along with coffee at work and discussed healthy \nbreakfast and lunch options. Recommended portions at dinner and exercising sessions of 10-15 minujtes\n3 times a week. Also suggested client keep food journal in order to keep track of meals/snacks and portions. \n\nMonitoring and Evaluation: Monitor weight, recommendations (following?) and nutrition-focused physical \nfindings. Follow up planned in 3 weeks. \n\nPaid 60$ For home visit: price adjusted from 85$ due to RD cancellation of previous appointment on short\nnotice. No receipt given. ',3);
...
-- Dump completed on 2017-01-28 21:16:08
